...
<html <?php language_attributes(); ?> class="no-js">
	<head>
        ...
        <link href="<?php echo get_template_directory_uri(); ?>/img/favicon/favicon.ico" rel="icon">
        ...
        <header class="header clear">
                ...
                <div class="logo">
                    <a href="<?php echo home_url(); ?>">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/img/cat-logo.png" alt="Logo" class="logo-img">
                    </a>
                </div>
                <!-- /logo -->
